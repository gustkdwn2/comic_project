										...
										<c:forEach items="${MembertList}" var="member">
											<tr>
												...
												<td style="width: 100px">
													<button id="modifyBtn" type="button" class="btn btn-info" data-toggle="modal" data-target="#MemberModifyModal">수정</button>
...
<script type="text/javascript">
	...
	$(document).on("click", "#modifyBtn", function () { 
		var myMEMBER_ID = $(this).data('modal'); 
		$(".modal #MEMBER_ID").val(myMEMBER_ID);
