				...
				<div class="col-lg-6 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							...
							<div id="linecanvas"><canvas id="line"></canvas></div>
						</div>
					</div>
				</div>
				<div class="col-lg-6 grid-margin stretch-card">
					<div class="card">
						<div class="card-body">
							...
							<div id="barcanvas"><canvas id="bar"></canvas></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-6 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								...
								<div id="horizontalbarcanvas"><canvas id="horizontalbar"></canvas></div>
							</div>
						</div>
				</div>
				<div class="col-lg-6 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								...
								<div id="horizontalRoombarcanvas"><canvas id="horizontalRoombar"></canvas></div>
							</div>
						</div>
				</div>
			</div>
