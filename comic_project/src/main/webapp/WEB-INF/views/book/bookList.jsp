...
<body>
	...
	<script src="/resources/js/bookTable.js?ver=37" ></script>
	<script src="/resources/js/bookRegister.js?ver=21" ></script>
	<script src="/resources/js/bookGet.js?ver=32" ></script>
</html>