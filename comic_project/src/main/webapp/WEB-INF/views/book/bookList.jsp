...
<body>
	...
	<script src="/resources/js/bookTable.js?ver=36" ></script>
	<script src="/resources/js/bookRegister.js?ver=20" ></script>
	<script src="/resources/js/bookGet.js?ver=31" ></script>
</html>