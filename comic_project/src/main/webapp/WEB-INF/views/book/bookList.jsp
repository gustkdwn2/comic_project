...
<body>
	...
	<script src="/resources/js/bookTable.js?ver=40" ></script>
	<script src="/resources/js/bookRegister.js?ver=31" ></script>
	<script src="/resources/js/bookGet.js?ver=41" ></script>
</html>