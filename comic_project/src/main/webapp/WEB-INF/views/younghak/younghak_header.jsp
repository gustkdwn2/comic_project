                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                       ...
                       <div class="template-demo">
                        <button type="button" 
                        	onclick="javascript:window.location.href='/managerpos/importdetail.co'"
                         class="btn btn-primary btn-rounded btn-fw">수입 상세 검색</button>
                          <button type="button"
                         onclick="javascript:window.location.href='/managerpos/Managerpos.co'"
                          class="btn btn-danger btn-rounded btn-fw">포스기 화면</button>
                        <button type="button"
                        onclick="javascript:window.location.href='/managerpos/login.co'"
